...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("entra_tenant_id", sa.String(length=255), nullable=True))
    op.add_column("users", sa.Column("last_login", sa.DateTime(), nullable=True))
    op.add_column("users", sa.Column("roles", sa.String(length=255), nullable=False, server_default="HelpDesk"))
